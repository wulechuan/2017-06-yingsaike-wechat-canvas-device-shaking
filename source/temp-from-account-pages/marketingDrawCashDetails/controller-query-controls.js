App.lazy.controller('marketingDrawCashDetailsQueryControls',
    [        '$scope', 'marketingDrawCashDetailsData',
	function ($scope,   dataService) {
        ...
        var appGlobalConfig = require('angularConfig');
        ...
        $scope.availableAccountTypes = appGlobalConfig.feeType;
        $scope.possiblePaymentStatuses = appGlobalConfig.payStatus;
        $scope.possibleApprovalStatuses = appGlobalConfig.approvalStatusd;
